...
# !!! Main.UserApp is configured as an alias for Main.AverageSolver and you might encounter it in some tests
using Main.AverageSolver, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "AverageSolver tests" begin
  @includetests ARGS
end
